...
function GuestRoomDetail() {
  ...
  useEffect(() => {
    if (payment === "mobile") setOpenMobile(true);
    if (successPayment) setOpenMobile(false);
  }, [openMobile, payment, successPayment]);
...
function MobilePaymentPopup({ handleClose, setSuccessPayment, totalPrice }) {
